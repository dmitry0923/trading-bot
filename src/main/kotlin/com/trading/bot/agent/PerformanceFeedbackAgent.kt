...
class PerformanceFeedbackAgent(
    ...
    fun ruleBasedFeedback(
        ...
        val raw =
            "{\"confidenceAdjustment\":$confidenceAdjustment,\"slAdjustmentPercent\":$slAdjustment," +
            ...
            StrategyFeedback(
                ...
                slAdjustmentPercent =
                    clamp(
                        ...
                        SL_ADJUSTMENT_PERCENT_MIN,
                        SL_ADJUSTMENT_PERCENT_MAX,
                    ),
                tpAdjustmentPercent =
                    clamp(
    ...
    private suspend fun saveAdjustments(
