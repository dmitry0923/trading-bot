 ...
 *
 * Для каждого тикера строится вектор признаков на ТЕКУЩИЙ момент (как на вход в
...
class MlScreeningService(
    ...
    suspend fun screen(
        ...
        val limit = (topN ?: mlConfig.screening.topN).coerceIn(1, MAX_TOP_N)
        ...
        val candidates = mutableListOf<MlScreeningCandidate>()
        ...
        for (ticker in requested) {
            ...
            candidates += bestCandidate(model, ticker, features, macro, inBlindSpot, generatedAt.hour)
        }
