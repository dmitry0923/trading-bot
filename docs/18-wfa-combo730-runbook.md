...
### Волна 3 — идёт с 2026-09-26 07:23 (15 конфигов, оркестратор pid 3344)

Список: `%TEMP%\opencode\combo730\wave3_configs.txt`, вывод в
`%TEMP%\opencode\combo730\wave3\`. Сетка построена только по осям, которые реально
влияют (funding 3-3/4-6/5-5/6-4/6-8/7-7, max-hold 184/460/644/1095, комбинация
fv4-4 × mh1095, orb/h1/short-окно 10-12 как проверки, контроль fv6-6).
Первые результаты: `td-fv7-7` **+191.38% / PF 2.70 / 45 сделок** (новый лидер),
`td-fv5-5` +158.52% / PF 2.69 / 37 сделок.
