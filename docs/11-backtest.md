...
> **ОПРОВЕРГНУТО 2026-09-20**: повторный прогон той же калибровки на полной
> живой тике-истории (46 124 свечи 2024-09-19..2026-09-19, с издержками/funding/liq-симуляцией)
> даёт OOS **−80.4%**, PF 0.72, consistency 0.25, robust=false — старый «+104%» был получен
> на неполной истории/старом режиме издержек. 730д OOS убыточен.
