...
class ApiController(
    ...
    suspend fun backtest(
        ...
        @RequestParam(required = false) orbWindowStartMinutes: Int?,
        @RequestParam(required = false) orbWindowEndMinutes: Int?,
        @RequestParam(required = false) vwapMrEnabled: Boolean?,
        @RequestParam(required = false) vwapMrDeviationSigma: Double?,
        @RequestParam(required = false) vwapMrMaxAdx: Double?,
        @RequestParam(required = false) vwapMrTimeframe: String?,
        @RequestParam(required = false) vwapMrMinSessionBars: Int?,
        @RequestParam(required = false) vwapMrBlockOnUnknown: Boolean?,
        ...
        @RequestParam(required = false) squeezeEnabled: Boolean?,
        @RequestParam(required = false) squeezeBlockOnUnknown: Boolean?,
        @RequestParam(required = false) panicReversalEnabled: Boolean?,
        @RequestParam(required = false) panicMinSessionDropPercent: Double?,
        @RequestParam(required = false) panicRsiPeriod: Int?,
        @RequestParam(required = false) panicMaxRsi: Double?,
        @RequestParam(required = false) panicTimeframe: String?,
        @RequestParam(required = false) panicRequireBullishBar: Boolean?,
        @RequestParam(required = false) panicMinBars: Int?,
        @RequestParam(required = false) panicBlockOnUnknown: Boolean?,
        @RequestParam(required = false) macroTrendEnabled: Boolean?,
        @RequestParam(required = false) macroTrendTimeframe: String?,
        @RequestParam(required = false) macroTrendFastEma: Int?,
        @RequestParam(required = false) macroTrendSlowEma: Int?,
        @RequestParam(required = false) macroTrendMinHigherBars: Int?,
        @RequestParam(required = false) macroTrendPullbackEmaPeriod: Int?,
        @RequestParam(required = false) macroTrendMaxDeviationPercent: Double?,
        @RequestParam(required = false) macroTrendBlockOnUnknown: Boolean?,
        ...
        val entryOverrides =
            EntryFilterOverrides(
                ...
                macroTrendTimeframe = macroTrendTimeframe,
